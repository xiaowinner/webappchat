...
} from "../Live2DFramework/src/live2dcubismframework";
import { CubismModelSettingJson } from "../Live2DFramework/src/cubismmodelsettingjson";
import { ICubismModelSetting } from "../Live2DFramework/src/icubismmodelsetting";
import { CubismUserModel } from "../Live2DFramework/src/model/cubismusermodel";
import { CubismDefaultParameterId } from "../Live2DFramework/src/cubismdefaultparameterid";

import { CubismMotion } from "../Live2DFramework/src/motion/cubismmotion";
import {
  ACubismMotion,
  FinishedMotionCallback,
} from "../Live2DFramework/src/motion/acubismmotion";
import {
  CubismMotionQueueEntryHandle,
  InvalidMotionQueueEntryHandleValue,
} from "../Live2DFramework/src/motion/cubismmotionqueuemanager";

import { CubismIdHandle } from "../Live2DFramework/src/id/cubismid";

import { csmVector } from "../Live2DFramework/src/type/csmvector";
import { csmMap } from "../Live2DFramework/src/type/csmmap";
import { csmRect } from "../Live2DFramework/src/type/csmrectf";
import { csmString } from "../Live2DFramework/src/type/csmstring";

import { CubismMatrix44 } from "../Live2DFramework/src/math/cubismmatrix44";

import { CubismLogError, CubismLogInfo } from "../Live2DFramework/src/utils/cubismdebug";

import { CubismEyeBlink } from "../Live2DFramework/src/effect/cubismeyeblink";
import {
  BreathParameterData,
  CubismBreath,
} from "../Live2DFramework/src/effect/cubismbreath";

import CubismFramework = live2d.CubismFramework;

// import custom source
import { TextureInfo } from "./TextureManager";
import { Delegate, gl, canvas, frameBuffer } from "./Delegate";
import { Pal } from "./Pal";
...
export class Model extends CubismUserModel {
  ...
  private _MouthValueCallback: (() => number) | null = null
  ...
  public update(): void {
    ...
    if (this._lipsync) {
      ...
      if (this._MouthValueCallback)
        value = this._MouthValueCallback()
      else
